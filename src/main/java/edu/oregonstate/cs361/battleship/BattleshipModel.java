...
public class BattleshipModel {
    ...
    private Ship aircraftCarrier = new Ship("AircraftCarrier",5, 5, new Coordinate(0,0),new Coordinate(0,0));
    private Ship battleship = new Ship("Battleship",4, 4, new Coordinate(0,0),new Coordinate(0,0));
    private Ship cruiser = new Ship("Cruiser",3, 3, new Coordinate(0,0),new Coordinate(0,0));
    private Ship clipper = new Ship("Clipper",2, 2, new Coordinate(0,0),new Coordinate(0,0));
    private Ship dinghy = new Ship("dinghy",2, 2, new Coordinate(0,0),new Coordinate(0,0));

    private Ship computer_aircraftCarrier = new Ship("Computer_AircraftCarrier",5, 5, new Coordinate(2,2),new Coordinate(2,7));
    private Ship computer_battleship = new Ship("Computer_Battleship",4, 4, new Coordinate(2,8),new Coordinate(6,8));
    private Ship computer_cruiser = new Ship("Computer_Cruiser",3, 3, new Coordinate(4,1),new Coordinate(4,4));
    private Ship computer_clipper = new Ship("Computer_Clipper",2, 2, new Coordinate(7,3),new Coordinate(7,5));
    private Ship computer_dinghy = new Ship("Computer_dinghy",2, 2, new Coordinate(9,6),new Coordinate(9,8));
