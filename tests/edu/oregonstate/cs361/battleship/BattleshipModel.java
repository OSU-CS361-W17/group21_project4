...
public class BattleshipModel {
    ...
    private Ship clipper = new Ship("Clipper",2, new Coordinate(0,0),new Coordinate(0,0));
    private Ship dinghy = new Ship("dinghy",2, new Coordinate(0,0),new Coordinate(0,0));
    ...
    private Ship computer_clipper = new Ship("Computer_Clipper",2, new Coordinate(7,3),new Coordinate(7,5));
    private Ship computer_dinghy = new Ship("Computer_dinghy",2, new Coordinate(9,6),new Coordinate(9,8));
